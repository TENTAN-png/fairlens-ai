  ...
  return (
    <div className="hero">
      <div className="hero-content">
        ...
        <p>
          An enterprise-grade platform to scan datasets and software models for hidden bias, audit generative AI systems, 
        ...
        <div className="hero-features" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))' }}>
          <div className="hero-feature-card" onClick={onGetStarted} style={{ cursor: 'pointer' }}>
          ...
          <div className="hero-feature-card" onClick={onGetStarted} style={{ cursor: 'pointer' }}>
            ...
            <h3>Model Inspection Studio</h3>
            <p>Audit traditional ML models (pickle/joblib) for prediction fairness, decision consistency, and SHAP explainability</p>
          </div>
          <div className="hero-feature-card" onClick={onGetStarted} style={{ cursor: 'pointer' }}>
          ...
          <div className="hero-feature-card" onClick={onGetStarted} style={{ cursor: 'pointer' }}>
            <div className="feature-icon" style={{ background: 'var(--amber-bg)', color: '#d4af37' }}>
